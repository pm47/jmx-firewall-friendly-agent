...
<pre><code>
    java -Djmx.host=<DESIRED_HOSTNAME> -Djmx.port=<DESIRED_PORT> -javaagent:<PATH_TO_AGENT_JAR> ... (other stuff)
</code></pre>	

Example (tunneling friendly):

<pre><code>
    java -Djmx.port=22000 -javaagent:jmx-firewall-friendly-agent-1.0-SNAPSHOT.jar ... (other stuff)
</code></pre>	
